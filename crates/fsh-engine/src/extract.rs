...
/// Extracts the command arguments from the given command.
...
/// Extracts the command name from the given command.
...
/// Extracts the assign key and value from the given assign.
