...
/// Parse an expr.
fn parse_expr(token: &Token, exclude: Vec<Token>) -> Result<Expr> {
    for tkn in exclude {
        if token == &tkn {
...
pub fn parse_assign(tokens: &[Token; 3]) -> Result<Assign> {
    ...
    let value = parse_expr(&tokens[2], vec![Token::Ident(String::default())])?;
...
pub fn parse_command(tokens: &[Token]) -> Result<Command> {
    ...
    let (tokens, background) = if tokens[1..].contains(&Token::Ampersand) {
        let (left, _) = split(&Token::Ampersand, &tokens[1..]);
        (left, true)
    } else {
...
pub fn parse_pipe(tokens: &[Token]) -> Result<Pipe> {
    ...
    let command_tokens = recursion_split(&Token::Pipe, tokens);
...
mod tests {
    ...
    fn test_parse_string() {
        // parse_string(token: &Token) -> Result<Expr>
        //
    ...
    #[test]
    fn test_parse_ident() {
        // parse_ident(token: &Token) -> Result<Expr>
        //
    ...
    fn test_parse_number() {
        // parse_number(token: &Token) -> Result<Expr>
        //
        // Token::Number(100)
        // Expr::Number(100)

        let token = Token::Number(100);

        let expr = parse_number(&token).unwrap();

        assert_eq!(expr, Expr::Number(100));
    }

    #[test]
    fn test_parse_fd() {
        // parse_fd(token: &Token) -> Result<Expr>
        //
        // Token::FD(1)
        // Expr::FD(1)
    ...
    fn test_parse_assign() {
        // parse_assign(tokens: &[Token; 3]) -> Result<Assign>
        //
        // Token::Ident("a".to_string())
        // Token::Assign
        // Token::String("hello".to_string())
        // Assign { ident: Expr::Ident("a".to_string()), expr: Expr::String("hello".to_string()) }
        ...
        assert_eq!(assign.key, Expr::Ident("a".to_string()));
        assert_eq!(assign.value, Expr::String("hello".to_string()));
    }

    #[test]
    fn test_parse_abbreviated_redirect() {
        // parse_abbreviated_redirect(tokens: &[Token; 2]) -> Result<Redirect>
        //
        //-----------------------------------
        // Token::Gt
        // Token::String("hello".to_string())
        // Redirect { left: Expr::FD(1), right: Expr::String("hello".to_string()), operator: RedirectOperator::Gt }
        //
        //-----------------------------------
        // Token::Lt
        // Token::String("hello".to_string())
        // Redirect { left: Expr::FD(0), right: Expr::String("hello".to_string()), operator: RedirectOperator::Lt }
    ...
    fn test_parse_normal_redirect() {
        // parse_normal_redirect(tokens: &[Token; 3]) -> Result<Redirect>
        //
        //-----------------------------------
        // Token::FD(1)
        // Token::Gt
    ...
    fn test_parse_redirect() {
        // parse_redirect(tokens: &[Token]) -> Result<Redirect>
        //
        //-----------------------------------
        // Token::Gt
        // Token::String("hello".to_string())
    ...
    fn test_parse_command_expr() {
        // parse_command_expr(token: &Token) -> Result<Expr>
        //
        //-----------------------------------
        // Token::String("hello".to_string())
        // Expr::String("hello".to_string())
        ...
        assert_eq!(
            parse_command_expr(&Token::Number(100)).unwrap(),
            Expr::Number(100)
        );
    }
    ...
    fn test_parse_command_args_and_redirects() {
        // parse_command_args_and_redirects(tokens: &[Token]) -> Result<(Vec<Expr>, Vec<Redirect>)>
        //
        // Token::String("hello".to_string())
        ...
        //
        // args: [Expr::String("hello".to_string()), Expr::String("world".to_string())]
        // redirects: [Redirect { left: Expr::FD(1), right: Expr::String("file".to_string()), operator: RedirectOperator::Gt }]

        let (args, redirects) = parse_command_args_and_redirects(&vec![
            Token::String("hello".to_string()),
            Token::String("world".to_string()),
            Token::Gt,
            Token::String("file".to_string()),
    ...
    fn test_parse_command() {
        // parse_command(tokens: &[Token]) -> Result<Command>
        //
        //-----------------------------------
        ...
        //     args: [Expr::String("hello".to_string()), Expr::String("world".to_string())],
        //     redirects: [
        //         Redirect { left: Expr::FD(1), right: Expr::String("file".to_string()), operator: RedirectOperator::Gt },
        //         Redirect { left: Expr::FD(2), right: Expr::String("file2".to_string()), operator: RedirectOperator::Gt }
        //     ],
        //     background: false
        // }
    ...
    #[test]
    fn test_parse_pipe() {
        // parse_pipe(tokens: &[Token]) -> Result<Pipe>
        //
        //-----------------------------------
        // Token::String("echo".to_string())
        // Token::String("hello".to_string())
        ...
        //         Command {
        //             expr: Expr::String("echo".to_string()),
        //             args: [Expr::String("hello".to_string())],
        //             redirects: Vec::default(),
        //             background: false
        //         },
        //         Command {
        //             expr: Expr::String("cat".to_string()),
        //             args: [Expr::String("-b".to_string())],
        //             redirects: Vec::default(),
        //             background: false
        //         }
        //     ]
